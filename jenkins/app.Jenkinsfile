...
//         }
    ...
    parameters {
            ...
            string(name: 'POSTGRES_PASSWORD', defaultValue: '',  description: 'Postgres password', required: true)
            ...
            string(name: 'S3_BUCKET', defaultValue: '',  description: 'S3 bucket', required: true)
